...
const user: any = computed(() => usePage().props?.user)
...
const { openSubsidebar } = useSidebarLayoutContext()
if (openSubsidebar) {
  // openSubsidebar('BN6')
      ...
      <div class="columns is-multiline">
        ...
        <div class="column is-12">
          <div class="dashboard-card p-0">
            <iframe src="http://localhost:5601/goto/35cc82582d9fe8de08aedf97e6f41fbe?security_tenant=private" height="600" style="width:100%" />
          </div>
        </div>
      </div>
    </div>
