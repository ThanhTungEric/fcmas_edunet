...
const imgLanguage = new URL('/images/illustrations/right-panel/languages.svg', import.meta.url).href
const imgLanguageDark = new URL('/images/illustrations/right-panel/languages-dark.svg', import.meta.url).href
