...
const paginatedLink = (page = 1) => {
  if (props.useInertia) {
    return `${props.routerQueryKey}/${page}`
  }
  if (props.noRouter) {
    return {}
  }
...
const RouteComponent: any = props.useInertia ? Link : RouterLink
const routeLinkKey = props.useInertia ? 'href' : 'to'
</script>
...
<template>
  ...
  >
    <ul class="pagination-list">
      ...
      >
        <RouteComponent
          :[routeLinkKey]="paginatedLink(page)"
          tabindex="0"
          class="pagination-link"
      ...
      <li v-if="showLastLink">
        <RouteComponent
          :[routeLinkKey]="paginatedLink(lastPage)"
          tabindex="0"
          class="pagination-link"
    ...
    <RouteComponent
      :[routeLinkKey]="paginatedLink(currentPage - 1)"
      tabindex="0"
