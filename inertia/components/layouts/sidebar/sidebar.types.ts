...
export interface SubsidebarItemCollapseChild {
  type?: string
  label: string
  to?: string
  icon?: string
  tag?: string | number
  children2?: Array<SubsidebarItemCollapseChild>
...
//     children2?: Array<SubsidebarItemCollapse>
//   }[]
// }
export interface SubsidebarItemCollapse {
  type: 'collapse'
  ...
  label: string
  to?: string
  children: Array<SubsidebarItemCollapseChild>
}
